...
async def run_realtime_analysis_common(config: dict, current_func_name: str, current_func_addr: str, prompt_file: str, smart_select: bool, prompt_replacements: dict = None) -> bool:
    ...
    try:
        print("[AETHER] [Realtime] Initializing MCP SSE client...")
        async with sse_client(server_url) as streams:
            print("[AETHER] [Realtime] Initializing MCP Session...")
            async with ClientSession(streams[0], streams[1]) as session:
                ...
                print("[AETHER] [Realtime] Collecting functions with default criteria...")
                ...
                print("[AETHER] [Realtime] Gathering call relationships...")
                ...
                print(f"[AETHER] [Realtime] Collecting pseudocode for {len(selected_functions)} functions...")
                for func_info in selected_functions:
                    func_name = func_info["name"]
                    func_addr = func_info["address"]
